...
```{r constants}
onedrive <- "OneDrive - Oxford University Clinical Research Unit"
path2data <- str_replace(getwd(), "GitHub",
                         ifelse(grepl("apple", Sys.getenv("R_PLATFORM")),
                                paste0("Library/CloudStorage/", onedrive, "/GitHub"),
                                paste0(onedrive, "\\GitHub")))
```

```{r constants}
path2data <- str_replace(getwd(), "GitHub",
                         paste0(ifelse(grepl("apple", Sys.getenv("R_PLATFORM")),
                                       "Library/CloudStorage", ""),
                                "/OneDrive - Oxford University Clinical Research Unit",
                                "/GitHub"))
```
