---
title: "regularized glmmLasso for CRKP admission risk model"
output:
...
CRKP_admission <- readRDS("CRKP_admission.rds")
riskdata <- merge(all_data, CRKP_admission, by ="USUBJID", all=T )
riskdata <- riskdata %>%
